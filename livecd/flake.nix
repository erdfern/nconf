{
  ...
  outputs =
            ...
            (
              ...
              in
              {
                isoImage = {
                  ...
                  # slower-but-smaller xz.
                  # squashfsCompression = "zstd";

                  appendToMenuLabel = " YubiKey Live ${self.lastModifiedDate}";
                  # redundant if pulling in installation-cd-minimal
                  makeEfiBootable = true; # EFI booting
                  makeUsbBootable = true; # USB booting
                };

                hardware.nitrokey.enable = true; # it's just adding it to udev.packages, too.
                services = {
                  pcscd.enable = true;
    ...
    in
    {
      nixosConfigurations.customlive.x86_64-linux = mkSystem "x86_64-linux";
      nixosConfigurations.customlive.aarch64-linux = mkSystem "aarch64-linux";

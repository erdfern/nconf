...
{ pkgs, user, config, lib, me, ... }:
let
  cfg = config.kor.virtualisation.qemu;
in
{

  options.kor.virtualisation.qemu.enable = lib.mkEnableOption "Qemu/KVM virtualization";
  ...
  config = lib.mkIf cfg.enable {
    ...
    users.groups.libvirtd.members = [ "${me.user}" ];

  ...
  xdg.configFile."tridactyl/tridactylrc" = {
    ...
    text =
      ...
      ''
        ...
        set searchurls.@no https://search.nixos.org/options?channel=24.11&from=0&size=100&sort=alpha_asc&query=%s
        set searchurls.@hm https://home-manager-options.extranix.com/?query=%s&release=master
        set searchurls.@mn https://mynixos.com/search?q=%s
      '';
  };
